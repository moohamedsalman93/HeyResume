...
// node_modules/swiftlatex/dist/index.js
...
var LaTeXEngine = class {
  constructor({ extension, endpoint, workerPath }) {
    __publicField(this, "latexWorker");
    __publicField(this, "latexWorkerProxy");
    __publicField(this, "latexWorkerStatus", EngineStatus.Init);
  ...
  async loadEngine() {
    ...
    await new Promise((resolve) => {
      this.latexWorker.onmessage = (event) => {
        if (event.data === "wasm_initialized") {
          resolve();
        }
      };
    });
  ...
  closeWorker() {
    if (this.latexWorker !== void 0) {
      ...
      this.latexWorkerProxy = void 0;
    }
  }
};
var XeTeXEngine = class extends LaTeXEngine {
  constructor() {
    super({
      extension: ".xdv",
...
var DvipdfmxEngine = class extends LaTeXEngine {
  constructor() {
    super({
      extension: ".pdf",
      endpoint: "https://texlive2.swiftlatex.com/xetex/",
...
var PdfTeXEngine = class extends LaTeXEngine {
  constructor() {
    super({
      extension: ".pdf",
...
swiftlatex/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=swiftlatex.js.map
