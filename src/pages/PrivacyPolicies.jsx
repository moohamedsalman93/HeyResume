    ...
    return (
        <div className=" relative overflow-hidden">
            ...
            >
                ...
                <div>
                    <h1 className=' font-bold text-2xl'>Information Collection and Use</h1>
                    For a better experience while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to users name, email address, gender, location, pictures. The information that we request will be retained by us and used as described in this privacy policy.
                    The web app does use third party services that may collect information used to identify you.
                ...
                <div>
                    ...
                    This Services does not uses these “cookies” explicitly. However, the web app may use third party code and libraries that use “cookies” to collection information and to improve their services. You have the option to either accept or refuse these cookies, and know when a cookie is being sent to your device. If you choose to refuse our cookies, you may not be able to use some portions of this Service.

                </div>

                <div>
                    <h1 className=' font-bold text-2xl'>Location Information</h1>
                    Some of the services may use location information transmitted from users' mobile phones. We only use this information within the scope necessary for the designated service.

                </div>

                <div>
                    <h1 className=' font-bold text-2xl'>Device Information</h1>
                ...
                <div>
                    <h1 className=' font-bold text-2xl'>Children’s Privacy</h1>
                    This Services do not address anyone under the age of 13. We do not knowingly collect personal identifiable information from children under 13. In the case we discover that a child under 13 has provided us with personal information, we immediately delete this from our servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact us so that we will be able to do necessary actions.

                </div>

                <div>
                    <h1 className=' font-bold text-2xl'>Changes to This Privacy Policy</h1>
